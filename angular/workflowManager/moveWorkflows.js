...
workflowManagerApp.directive('openStep', ['$window', function ($window) {
    ...
    return {
        ...
        link: function ($scope, element, attrs) {
            element.bind('click', function () {
                //$window.open("llisapi.dll?func=work.EditTask&WorkID=" + $scope.currentWorkflow + "&SubWorkID=" + $scope.currentWorkflow + "&TaskID=" + attrs.taskid + "&paneindex=0&NextURL=", "resizable=1,scrollbars=1,menubar=1,toolbar=1,location=1,titlebar=1", false);
